...
exports.default = function () {
    ...
    function getMessageDescriptorKey(path) {
        ...
        console.warn(path.buildCodeFrameError('[React Intl] Skipping key, messages must be statically evaluate-able for extraction. See ' + fileNameFromPath(path)));
    ...
    function getMessageDescriptorValue(path) {
        ...
        console.warn(path.buildCodeFrameError('[React Intl] Skipping value, messages must be statically evaluate-able for extraction. See ' + fileNameFromPath(path)));
    ...
    function createMessageDescriptor(propPaths) {
        ...
        return propPaths.reduce(function (hash, _ref2) {
            ...
            var value = getMessageDescriptorValue(valuePath);
    ...
    return {
        visitor: {
            ...
            JSXOpeningElement: function JSXOpeningElement(path, state) {
                ...
                var moduleSourceNames = getModuleSourceNames(opts);
            ...
            CallExpression: function CallExpression(path, state) {
                var moduleSourceNames = getModuleSourceNames(state.opts);
...
var COMPONENT_NAMES = ['FormattedMessage', 'FormattedHTMLMessage', 'Msg', 'HtmlMsg'];

var FUNCTION_NAMES = ['defineMessages', 'msgs'];

var DESCRIPTOR_PROPS = new _set2.default(['id', 'description', 'defaultMessage']);

var INVALID_VALUE = (0, _symbol2.default)();

var fileNameFromPath = function fileNameFromPath(_ref) {
    var filename = _ref.hub.file.opts.filename;
    return filename;
};